...
from qadence import QNN, QuantumCircuit, chebyshev_feature_map, total_magnetization
from qadence.blocks import identity_block
...
identity_ansatz = identity_block(n_qubits, n_layers=2)
circuit = QuantumCircuit(n_qubits, feature_map, identity_ansatz)
ufa = QNN(circuit, observable=total_magnetization(n_qubits=5))
