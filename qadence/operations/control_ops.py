...
class CNOT(ControlBlock):
    ...
    def __init__(self, control: int, target: int, noise: AbstractNoise | None = None) -> None:
...
class MCZ(ControlBlock):
    ...
    def __init__(
        self, control: tuple[int, ...], target: int, noise: AbstractNoise | None = None
    ) -> None:
...
class CRY(MCRY):
    ...
    def __init__(
        self, control: int, target: int, parameter: TParameter, noise: AbstractNoise | None = None
    ):
        super().__init__((control,), target, parameter, noise=noise)
